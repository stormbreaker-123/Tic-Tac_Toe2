var chance = "Player 1";
var chance2 = document.getElementById("chance")
...
function check() {
    ...
    if (btn1 === "X" && btn2 === "X" && btn3 === "X") {
        ...
        document.getElementById("btn1").classList.add("trans");
        document.getElementById("btn2").classList.add("trans");
        document.getElementById("btn3").classList.add("trans");
        disable();
        ...
        chance2.innerHTML = "Player 1 Won";
        document.getElementById("btn4").classList.add("trans");
        document.getElementById("btn5").classList.add("trans");
        document.getElementById("btn6").classList.add("trans");
        disable()
    }
    else if (btn7 === "X" && btn8 === "X" && btn9 === "X") {

        chance2.innerHTML = "Player 1 Won"
        document.getElementById("btn7").classList.add("trans");
        document.getElementById("btn8").classList.add("trans");
        document.getElementById("btn9").classList.add("trans");
        disable()
    }
...
function reset() {
    ...
    for (let i = 1; i < 10; i++) {
        ...
        r.innerHTML = " "
        if(r.classList.contains("trans")){
            r.classList.remove("trans");
        };
